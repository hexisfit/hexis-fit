...
function buildPage(): string {
  ...
  p('}');
  p('function iw(){var h="";for(var i=1;i<=8;i++)h+="<button class=\'wb\' onclick=\'tw("+i+")\'><span>"+i+"</span><span class=\'wv\'>"+(i*300)+"ml</span></button>";document.getElementById("wbs").innerHTML=h}');
